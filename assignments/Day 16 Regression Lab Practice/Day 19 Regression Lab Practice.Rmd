...
kc.house=read.csv("kc_house_data.csv")
head(kc.house)
str(kc.house)
...
* Use your model to predict the value of the chosen variable for this group Camrys that are not part of the original dataset.
...
### Prediction
Use your model to predict the values of the houses in the kc_predict data file.
...
#### Make a display and discuss the residuals 
Create a residual plot and talk about what it means.
